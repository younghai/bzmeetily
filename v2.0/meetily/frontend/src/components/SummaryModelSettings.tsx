  ...
  useEffect(() => {
    const setupListener = async () => {
      ...
      const unlisten = await listen<ModelConfig>('model-config-updated', (event) => {
        console.log('SummaryModelSettings model-config-updated:', { provider: event.payload?.provider, model: event.payload?.model, hasApiKey: Boolean(event.payload?.apiKey) });
